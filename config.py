...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","@Sai_yamanaka_1001")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "Kammomusicbot)
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "╼⃝𖠁 ᴋᴀᴍɪɴᴏ ꭙ ᴍᴜsɪᴄ 𖠁⃝╾")
# ---------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Yashdubey213/SPOTIFY_MUSIC",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/animepfp101")
SOURCE = getenv("SOURCE", "https://github.com/Yashdubey213/SPOTIFY_MUSIC")
CHAT = getenv("CHAT", "https://t.me/friendzone104")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
...
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/qmnqu3.jpg"
)
